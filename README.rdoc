...
Install all OS dependencies like git, python, vim...
...
Install X11 (for macosx , windows)
 - For Mac: http://xquartz.macosforge.org/landing/
 - For Windows: http://sourceforge.net/projects/xming/

= Installation
 
 If Windows start Xming.
